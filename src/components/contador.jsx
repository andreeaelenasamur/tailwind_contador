...
export const Contador = () => {
    ...
    return (
        <div className="imagen md:py-12">
            <section className="mt-80 pt-40">
                <div className="container mx-auto px-6 md:px-12 xl:px-32">
                    <div className="text-center text-gray-800">
                        <div className="shadow block rounded-lg shadow-lg px-6 py-12 md:py-16 md:px-12">
                            <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">You clicked {count} times</h1>
